...
import { Separator } from "./component/Separator.tsx";
import { Disclosure, DisclosureHeader, DisclosurePanel } from "./component/Disclosure.tsx";
import { Button } from "./component/Button.tsx";
import { Tab, TabPanel, TabPanels, TabList, Tabs } from "./component/Tabs.tsx";
const apps = [
      ...
      {appViewVisible && <div ref={appViewRef} id="app-view">
        <Tabs>
          <TabList>
            ...
            <Tab id="files">setting</Tab>
          </TabList>
          <TabPanels>
            <TabPanel id="home">app</TabPanel>
            <TabPanel id="files">settings</TabPanel>
          </TabPanels>
        </Tabs>
